    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (choice) {
                ...
                case 5:
                    System.out.println("There are " + dictionary.size() + " elements in the list.");
                    do {
                        System.out.println("That’s an Invalid element.");
                        System.out.print(
                                "Enter the index (0 to " + (dictionary.size() - 1) + ") that you want to replace: ");
                        index = sc.nextInt();
                    } while (index < 0 || index >= dictionary.size());
                    System.out.println("Element at index " + index + " is " + dictionary.get(index) + ".");
                    sc.nextLine();
